      ...
      <HomeSection
        ...
        html={
          <div className="container-fluid form_container">
            <h1 className="heading_h1">Water Connection Type Master</h1>
            <div className="text-start mb-2">
              <Link to="/connection-type">
                <Button
                  type="btn-success"
                  buttonName="Back to Connection Type List"
                ...
                <div className="row">
                  <div className="col-md-6 ">
                    <div className="form-group">
                      <label htmlFor="connectionTypeName">Connection Type Name:</label>
                      <input
                        type="text"
